...
public class ShelvesActivity extends Activity {
  private class AddTask extends UserTask<String, Void, BooksStore.Book> {
    ...
    public BooksStore.Book doInBackground(String... params) {
      ...
      return BooksManager.loadAndAddBook(getContentResolver(), mBookId, BookStoreFactory.get(ShelvesActivity.this));
    }
    ...
    public void onPostExecute(BooksStore.Book book) {
      if (book == null) {
        ...
        UIUtilities.showFormattedImageToast(ShelvesActivity.this, R.string.success_added, ImageUtilities.getCachedCover(book
            .getInternalId(), mDefaultCover), book.getTitle());
      }
      hidePanel(mAddPanel, false);
    }
    ...
    public void onPreExecute() {
      if (mAddPanel == null) {
        ...
        ((TextView) mAddPanel.findViewById(R.id.label_import)).setText(getText(R.string.add_label));
  ...
  private class ImportTask extends UserTask<Void, Integer, Integer> {
    ...
    public Integer doInBackground(Void... params) {
      ...
      try {
        if (mBooks == null) {
          mBooks = ImportUtilities.loadItems();
        }
    ...
    public void onPostExecute(Integer countImport) {
      if (countImport == null) {
        ...
        UIUtilities.showFormattedToast(ShelvesActivity.this, R.string.success_imported, countImport);
      }
      hidePanel(mImportPanel, true);
    }
  ...
  private class ShelvesScrollManager implements AbsListView.OnScrollListener {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
      if (mScrollState == SCROLL_STATE_FLING && scrollState != SCROLL_STATE_FLING) {
        ...
        final Message message = handler.obtainMessage(MESSAGE_UPDATE_BOOK_COVERS, ShelvesActivity.this);
  ...
  public boolean onPrepareOptionsMenu(Menu menu) {
    ...
    item.setEnabled(scanAvailable && (mAddTask == null || mAddTask.getStatus() == UserTask.Status.FINISHED));
  ...
  private void onScanCheck(Intent data) {
    ...
    if (ScanIntent.FORMAT_EAN_13.equals(bundle.getString(ScanIntent.SCAN_RESULT_FORMAT))) {
      ...
      if (bookId == null) {
        UIUtilities.showImageToast(this, R.string.success_book_not_found, getResources().getDrawable(R.drawable.unknown_book));
      } else {
        UIUtilities.showImageToast(this, R.string.error_book_exists, ImageUtilities.getCachedCover(bookId, mDefaultCover));
      }
    }
  }
